...
namespace RestaurantOtomasyonuLive
{
    ...
    {
        private Connection2 conn = new Connection2();
        private ContextMenuStrip ctxOrder = new ContextMenuStrip();
        ...
        private void LoadOrders(DateTime? start = null, DateTime? end = null, string search = "")
        {
            const string sql = @"
                SELECT
            ...
            {
                string status = row.Cells["Durum"].Value as string;
                if (status == "Beklemede")
        ...
        private void ctxOrder_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
