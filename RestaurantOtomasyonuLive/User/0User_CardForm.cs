...
namespace RestaurantOtomasyonuLive
{
    public partial class User_CardForm : Form
    {
        ...
        private void StilizeDataGridView()
        {
            ...
            dataGridView3.DataSource = sqlMethods4Ace3.GetCartContents(AppSession.CartId);
        ...
        private void btn_remove_Click(object sender, EventArgs e)
        {
            ...
            if (type == "Reservation")
            {
                ok = sqlMethods4Ace3.RemoveReservationFromCart(AppSession.CartId);
            }
            else if (type == "Meal")
            {
                ok = sqlMethods4Ace3.RemoveMealFromCart(AppSession.CartId, itemId);
            }
        ...
        private void btn_increase_Click(object sender, EventArgs e)
        {
            ...
            if (sqlMethods4Ace3.UpdateMealQuantity(AppSession.CartId, urunId, quantity))
                LoadCart();
        }
