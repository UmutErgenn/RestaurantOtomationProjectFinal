...
namespace RestaurantOtomasyonuLive
{
    public partial class User_CardForm : Form
    {
        ...
        {
            // 1) Sepeti çek
            DataTable dt = sqlMethods.GetCartContents(AppSession.CartId);
        ...
        private void StilizeDataGridView()
        {
            ...
            dataGridView3.DataSource = sqlMethods.GetCartContents(AppSession.CartId);
        ...
        private void btn_card_approve_Click(object sender, EventArgs e)
        {
            ...
            int orderId = sqlMethods.ConfirmCart(AppSession.CartId);
            ...
            if (orderId > 0) {
                ...
                if (reservationRow != null)
                {
                    ...
                    sqlMethods.ConfirmReservation(reservationId, orderId);
                }
        ...
        private void btn_remove_Click(object sender, EventArgs e)
        {
            ...
            if (type == "Reservation")
            {
                ok = sqlMethods.RemoveReservationFromCart(AppSession.CartId);
            }
            else if (type == "Meal")
            {
                ok = sqlMethods.RemoveMealFromCart(AppSession.CartId, itemId);
            }
        ...
        private void btn_increase_Click(object sender, EventArgs e)
        {
            ...
            if (sqlMethods.UpdateMealQuantity(AppSession.CartId, urunId, quantity))
                LoadCart();
        }
